...
window.gMessageTester = {
	...
	,cssUrl: "./data/others/plugin/seira/testMessagePlus/style.css"
	,sampleUrl: "./data/others/plugin/seira/testMessagePlus/sampletext.ks"
...
(function(TM) {
	...
	TM.appendGlyph = function() {
		...
		this.messageArea.append('<span style="display: inline-block; width: 10px; height: 1px; background-color: ' + color + '; transform: translateY(-6px);" class="img_next_test">　</span>')
	};
